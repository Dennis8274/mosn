...
type StreamResetReason2 string

// Group of stream reset reasons
const (
	StreamConnectionTermination2 StreamResetReason = "ConnectionTermination"
	StreamConnectionFailed2      StreamResetReason = "ConnectionFailed"
	StreamConnectionSuccessed2   StreamResetReason = "ConnectionSuccessed"
	StreamLocalReset2            StreamResetReason = "StreamLocalReset"
	StreamOverflow2              StreamResetReason = "StreamOverflow"
	StreamRemoteReset2           StreamResetReason = "StreamRemoteReset"
	UpstreamReset2               StreamResetReason = "UpstreamReset"
	UpstreamGlobalTimeout2       StreamResetReason = "UpstreamGlobalTimeout"
	UpstreamPerTryTimeout2       StreamResetReason = "UpstreamPerTryTimeout"
)
...
type StreamEventListener2 interface {
...
type StreamReceiveListener2 interface {
...
type StreamConnection2 interface {
...
type ServerStreamConnection2 interface {
	StreamConnection2
}

// ClientStreamConnection is a client side stream connection.
type ClientStreamConnection2 interface {
	StreamConnection2
...
type StreamConnectionEventListener2 interface {
...
type ServerStreamConnectionEventListener2 interface {
	StreamConnectionEventListener
...
type PoolFailureReason2 string

// PoolFailureReason types
const (
	Overflow2          PoolFailureReason = "Overflow"
	ConnectionFailure2 PoolFailureReason = "ConnectionFailure"
)

//  ConnectionPool is a connection pool interface to extend various of protocols
type ConnectionPool2 interface {
	Protocol() api.Protocol
...
type PoolEventListener2 interface {
